...
public class FenetreSolution extends JFrame implements KeyListener, ComponentListener{
	...
	private Instanciation solution;
	 ...
	 */
	public FenetreSolution(Instanciation solution, int l, int h) {
		this.largeur = l;
		this.hauteur = h;
	...
	public void setSolution(Instanciation solution) {
		this.solution = solution;
		repaint();
	}
	...
	public void paint(Graphics g) {
			...
			setTitle(this.solution.getNbAffectees()+"/"+this.solution.getNombreDeVariables()+" variables affectees");
						
			int n = this.solution.getNombreDeVariables();
			Individu individu = new Individu(solution);
